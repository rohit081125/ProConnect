...
export default function Profile() {
  ...
  const userWorks = useMemo(() => {
    return workPosts.filter((w) => w.postedBy === userId);
  }, [workPosts, userId]);
  ...
  useEffect(() => {
    ...
    const loadActivityData = async () => {
      try {
        ...
        const [worksResponse, appsResponse] = await Promise.all([
          getAllWorks(),
                    ...
                    <Card className="rounded-3xl border shadow-sm">
                      <CardContent className="p-5 md:p-6 flex flex-col justify-between h-full">
                        <div>
                          ...
                          <h4 className="text-sm font-semibold mb-2">Email Help Desk</h4>
                          <p className="text-xs text-muted-foreground leading-relaxed">
                            Have questions or account troubles? Mail the support team directly. We are always happy to help.
                          </p>
                        </div>
                        <div className="mt-5">
                          <Button
                            ...
                            onClick={() => window.open("mailto:rohitdongre1108@gmail.com?subject=ProConnect%20Support%20Request")}
                          >
                    ...
                    <Card className="rounded-3xl border shadow-sm">
                      <CardContent className="p-5 md:p-6 flex flex-col justify-between h-full">
                        <div>
                          ...
                          <h4 className="text-sm font-semibold mb-2">Message Administrator</h4>
                          <p className="text-xs text-muted-foreground leading-relaxed">
                            Start a direct live chat with the support administrator to resolve any questions or issues.
                          </p>
                        </div>
                        <div className="mt-5">
                          <Button
                            className="w-full rounded-xl bg-gradient-to-r from-accent to-accent/90"
                            onClick={() => setLocation("/messages?support=true")}
                          >
                            Start Chat
                          </Button>
                        </div>
